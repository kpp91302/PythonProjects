...
print("Hello Mr. Spencer, We understand you need a new alias for Gus for your next adventure.")
print("We would love to assist you today!")
...
#choose first name and assign to a variable
#choose last name and assign to a variable
while True:
